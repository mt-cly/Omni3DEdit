...
def create_samplers(
    ...
    guider_mapping = {
        ...
        3: MultiviewCFG_uc_no_sourceview
    }
    samplers = []
...
def get_value_dict(
    ...
    # Get the value dictionary for the current batch of images and their associated metadata.
...
def do_sample(
    ...
    **_,
    ...
    with torch.inference_mode(), torch.autocast("cuda"):
        ...
        uc_dense_vector = c_dense_vector # uc 和 c 的 dense_vector 是一样的
        c = {
